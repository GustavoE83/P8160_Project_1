---
title: "Type 1 and Power for different n, decreasing"
...
sim_decreases = function(effect, n){
...
decreases = decreases %>%
  mutate(tests = map2(effect, n, sim_decreases)) %>%
  unnest_wider(tests)
```
...
results %>%
  ...
  labs(title = "Power of log-rank tests",
       subtitle = "Diminishing effect model, t_0 = 0.8",
       x = "Sample size",
       y = "Power",
       color = "Test")
```
